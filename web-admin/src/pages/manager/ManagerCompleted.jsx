...
export default function ManagerCompleted() {
  ...
  const [activeCategory, setActiveCategory] = useState('private'); // private, public, merged
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex border-b">
        <button
          className={`mr-6 pb-2 text-sm font-semibold transition-colors duration-200 ${
        ...
        <button
          ...
          onClick={() => setActiveCategory('merged')}
        >
                ...
                return (
                  <div className="rounded-lg border bg-white p-4 shadow-sm" key={item.id}>
                    ...
                    {item.completionPhotoUri && (
                      <img src={item.completionPhotoUri} alt="proof" className="mt-2 h-32 rounded border object-cover" />
                    )}
                    {/* Feedback */}
                    {item.feedbackText && (
