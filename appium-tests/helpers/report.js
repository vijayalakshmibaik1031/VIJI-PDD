...
async function writeExcelReport(results, meta) {
  ...
  readySheet.addRow({ kpi: 'Backend API Connectivity', status: 'https://viji-pdd-production-7c95.up.railway.app/', score: 'CONNECTED' });
      ...
      children: [
        ...
        new Paragraph({
          children: [
            ...
            new TextRun({ text: 'https://viji-pdd-production-7c95.up.railway.app' }),
          ],
          spacing: { after: 300 }
        }),
        new Paragraph({
